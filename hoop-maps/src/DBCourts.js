...
// let courtLat = allCourts[i].lat
// let courtLon = allCourts[i].lon
// console.log(allCourts[i])
// }

const courtPins = allCourts.map(court => {
return {
"courtLat": Number(court.lat), 
"courtLon": Number(court.lon), 
